...
bindings_dir = os.path.join(root_dir, 'batteries', 'godot', 'bindings')
...
def write_api_pxd(echo=print):
    ...
    output_dir = os.path.join(root_dir, 'batteries', 'godot_headers')
...
def generate(generate_cpp=True, generate_cython=True, generate_python=True, echo=print, preloaded_classes=None):
    ...
    with open(os.path.join(root_dir, 'batteries', 'godot_headers', 'api.json'), encoding='utf-8') as fp:
