...
PyObject *PoolByteArray::py_ndarray(bool readonly) const { return readonly ? _poolbytearray_to_numpy_ro(*this) : _poolbytearray_to_numpy(*this); }
...
PyObject *Vector2::py_ndarray() const {
  npy_intp dims[] = {2};
...
PyObject *Vector3::py_ndarray() const {
  npy_intp dims[] = {3};
  PyObject *arr = PyArray_SimpleNewFromData(1, dims, NPY_FLOAT, (void *)this);
  Py_XINCREF(arr);
  return arr;
